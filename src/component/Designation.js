...
function Designation() {
    ...
    // const Hello = {
    //     departmentid: "a74585b3-62da-4b1c-bc11-8baf27a9403d",
    //     designation: "Senior Software Engineer",
    //     createdon: "2023-11-15T10:20:17.384Z",
    //     createdpurpose: "To lead the software development team",
    ...
    //     axios.post("http://localhost:5247/api/Designation/CreateDesignation", Hello).then(res => console.log(res)). catch(err => console.error(err))
    //     console.log("Click")
    //     }
    ...
    const [data, setData] = useState ({
      ...
      function Designations(event){
        ...
        axios.post("http://localhost:7035/api/Designation/CreateDesignation", {data})
  ...
  const [theme, setTheme] = useState("theme");
    ...
    return (
        ...
        {/* <button className='' onClick={handleMyButton}>  handleMyButton </button> */}
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={handleInput} id='designation'
                  required  />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                {/* <input type="text" className="form-control" onChange={handleInput} id='createdon'
                 required  /> */}
            </div>
        </div>
    </div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={handleInput} id='createdpurpose'
                  required  />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={handleInput} id='designationtype'
                 required  />
            </div>
        </div>
    </div>
